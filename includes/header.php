...
<head>
    ...
    <script
        type="application/ld+json">[{"@context":"https://schema.org","@type":"WebSite","url":"https://Timur Scher Films.de","name":"Mvc Customs","potentialAction":{"@type":"SearchAction","target":"https://Timur Scher Films.de/search?q={search_term_string}","query-input":"required name=search_term_string"}},{"@context":"https://schema.org","@type":"Organization","url":"https://Timur Scher Films.de","name":"Mvc Customs","sameAs":[]}]</script>
    <style>
        .w-webflow-badge {
...
<body class="body">
    ...
    <div data-collapse="medium" data-animation="default" data-duration="0" data-easing="ease-in-out"
        data-easing2="ease-in-out" data-doc-height="1" role="banner" class="navbar w-nav">
        <div class="container w-container"><a href="index.php"
            ...
            <nav role="navigation" id="w-node-_04a58433-f211-4564-acd1-3dc3cd22fee4-cd22fee0"
                class="open_nav_menu w-nav-menu"><a href="index.php" aria-current="page"
                    class="nav_link w-nav-link w--current">START</a>
                <div data-hover="true" data-delay="0" class="w-dropdown">
                    <div data-w-id="1997e849-d125-6321-d7d8-0a61e68a6dcb" class="dropdown-toggle w-dropdown-toggle">
                        <div class="icon w-icon-dropdown-toggle"></div>
                        <a href="#" class="nav_link w-nav-link">Service</a>
                    </div>
                    <nav class="service_dropdown w-dropdown-list">
                        <a href="sternenhimmel.php" class="dropdown_link w-dropdown-link">Automotive</a>
                        <a href="fahrzeug-individualisierung.php" class="dropdown_link w-dropdown-link">Imagefilms</a>
                        <a href="fahrzeug-folierung.php" class="dropdown_link w-dropdown-link">Musikvideo</a>
                        <a href="felgen-reifen.php" class="dropdown_link w-dropdown-link">Hochzeit</a>

                    </nav>
                </div>
                <!-- <a href="brabus.php" class="nav_link w-nav-link">BRABUS</a>
