...
<div id="luxy" class="smooth-wrapper">
    ...
    <div class="atf_container">
      <div data-delay="15000" data-animation="fade" class="atf_slider w-slider" data-autoplay="true"
        ...
        <div class="mask atf_scaling_up w-slider-mask">
          <div class="slide_vorlage slide_1 rr_slide_video w-slide">
            <div data-poster-url="https://public/60ac0cc200e8876bb293a30f_ZPerformanceFelge-poster-00001.jpg"
              ...
              <div class="atv_heading_wrapper">
                <h3 class="atv_heading">FELGEN &amp; REIFEN<br /></h3>
                <p class="atv_paragraph rr_atv_paragraph">An unserem Standort in Marienfeld bieten wir umfangreichen
                  Service, wenn es um Felgen &amp; Reifen geht. Dabei arbeiten wir zusammen mit namhaften Herstellern,
                  wie Pirelli, Michelin, Continental &amp; Goodyear.</p>
              </div>
            </div>
          </div>
          <div class="slide_vorlage slide_1 rr_slide_02 w-slide">
            <div class="atv_heading_wrapper">
              <h3 class="atv_heading">FELGEN &amp; REIFEN<br /></h3>
              <p class="atv_paragraph rr_atv_paragraph">An unserem Standort in Marienfeld bieten wir umfangreichen
                Service, wenn es um Felgen &amp; Reifen geht. Dabei arbeiten wir zusammen mit namhaften Herstellern,
                wie Michelin, Continental &amp; Goodyear.</p>
            </div>
          </div>
          <div class="slide_vorlage slide_1 rr_slide_03 w-slide">
            <div class="atv_heading_wrapper">
              <h3 class="atv_heading">FELGEN &amp; REIFEN<br /></h3>
              <p class="atv_paragraph rr_atv_paragraph">An unserem Standort in Marienfeld bieten wir umfangreichen
                Service, wenn es um Felgen &amp; Reifen geht. Dabei arbeiten wir zusammen mit namhaften Herstellern,
          ...
          <div class="slide_vorlage slide_1 rr_slide_04 w-slide">
            <div class="atv_heading_wrapper">
              <h3 class="atv_heading">FELGEN &amp; REIFEN<br /></h3>
              <p class="atv_paragraph rr_atv_paragraph">An unserem Standort in Marienfeld bieten wir umfangreichen
                Service, wenn es um Felgen &amp; Reifen geht. Dabei arbeiten wir zusammen mit namhaften Herstellern,
  ...
  <div class="information">
    <div class="information_wrapper rr_information_wrapper scale_up_1-1">
      <div class="versprechen_info">
        <div id="w-node-fcc52073-11ce-c5d9-c72c-ed2e4deba9c4-83dce9bd" data-w-id="fcc52073-11ce-c5d9-c72c-ed2e4deba9c4"
          style="opacity:0" class="versprechen_block versprechen_gradient">
          <h4 class="versprechen_heading">Sonderabnahme</h4>
          <p class="versprechen_paragraph">Felgen, Tuning und Umbauten zulassen: Wir lassen Gutachten erstellen, damit
            Sie Ihr Fahrzeug mit einer Einzelbetriebserlaubnis <br />zulassen können.<br /></p>
        </div>
        <div id="w-node-_66ce48b3-e425-e400-abc8-0ff1bf450bee-83dce9bd" data-w-id="66ce48b3-e425-e400-abc8-0ff1bf450bee"
          style="opacity:0" class="versprechen_block versprechen_gradient">
          <h4 class="versprechen_heading">Auswuchten</h4>
          <p class="versprechen_paragraph">Perfekt ausgewuchtet! Wir garantieren die optimalen Parameter für die
            Langlebigkeit Ihrer Räder.<br /></p>
        </div>
        <div id="w-node-f81115a3-2afb-c226-0fcd-bf8573361d05-83dce9bd" data-w-id="f81115a3-2afb-c226-0fcd-bf8573361d05"
          style="opacity:0" class="versprechen_block versprechen_gradient">
          <h4 class="versprechen_heading">Einlagerung</h4>
          <p class="versprechen_paragraph">Der Saisonwechsel steht bevor? Dann brauchen Sie nur noch einen Termin zu
            vereinbaren.  Ihre Räder warten bereits auf Sie.<br /></p>
        </div>
      </div>
      <div class="info_grid rr_info_grid">
        <div id="w-node-_0816c39c-7a4e-8a33-e038-7f24522f521b-83dce9bd" class="info">
          <h2 class="info_heading">KONTROLLIERT<br />&amp; SORGFÄLTIG</h2>
          <p class="info_paragraph">Als Spezialist können wir Ihnen das passende Komplett-Rad zusammenstellen, welches
            garantiert auf Ihr Fahrzeug passt und auch gefahren werden darf. <br /></p>
          <p class="info_paragraph">Für uns ist es wichtig, Ihnen den Kauf von Kompletträdern so einfach und bequem
            wie möglich zu machen. Bei uns haben Sie die Möglichkeit Felgen und Reifen von einer Vielzahl von
            Herstellern zu beziehen. Wir bieten eine breite Auswahl zwischen Stahl- und Alufelgen und natürlich
            zwischen Winterreifen, Sommerreifen sowie Ganzjahresreifen.<br /></p>
        ...
        <div id="kontakt_formular" class="kontakt_formular">
          <div class="footer-contact-form w-form">
            <form id="wf-form-kontakt_formular" name="wf-form-kontakt_formular" data-name="kontakt_formular"
              action="https://submit-form.com/6s49DIZQ" method="post" data-wf-page-id="5fdbc1d703f8127b83dce9bd"
