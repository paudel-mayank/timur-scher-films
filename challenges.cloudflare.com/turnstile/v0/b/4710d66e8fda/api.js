...
(function() {
  ...
  function ot(e, t) {
    return t = t != null ? t : {},
      Object.getOwnPropertyDescriptors
        ...
        : kr(Object(t)).forEach(function(a) {
  ...
  function We(e, t) {
    var a = {
      ...
      l,
      m;
    return m = { next: h(0), throw: h(1), return: h(2) },
    ...
    function s(p) {
      ...
      for (; m && (m = 0, p[0] && (a = 0)), a;) {
        try {
          if (
            o = 1,
              c && (l = p[0] & 2 ? c.return : p[0] ? c.throw || ((l = c.return) && l.call(c), 0) : c.next)
              && !(l = l.call(c, p[1])).done
          ) return l;
  ...
  function vt(e, t, a, o, c, l, m, h) {
    ...
    return "".concat(s, "/cdn-cgi/challenge-platform/").concat(p, "turnstile/if/ov2/av0/rcv").concat(o, "/").concat(
      e,
      "/",
    ).concat(t, "/").concat(a.theme, "/").concat(A, "/").concat(m, "/").concat(a.size, "/").concat(a.language, "/")
      .concat(_);
  }
  var mt = function(e) {
      var t,
        ...
        c = e.state !== ge.FailureFeedbackCode
          && (e.state === ge.FailureFeedback || e.state === ge.FailureHavingTroubles || !e.errorCode),
        l,
        m = L(
          Nr,
          (l = (t = e.displayLanguage) === null || t === void 0 ? void 0 : t.toLowerCase()) !== null && l !== void 0
            ? l
            : "nonexistent",
        ),
        h,
        s = L(
          Mr,
          (h = (a = e.displayLanguage) === null || a === void 0 ? void 0 : a.toLowerCase()) !== null && h !== void 0
            ? h
            : "nonexistent",
        );
      return o
        ? Lr({ isModeratelyVerbose: s, isSmallerFeedback: c, isVerboseLanguage: m })
        : c && m
        ? "630px"
        : c && s
        ? "620px"
  ...
  function ke(e, t, a) {
    return Be() ? ke = Reflect.construct : ke = function(c, l, m) {
      var h = [null];
      h.push.apply(h, l);
      var s = Function.bind.apply(c, h), p = new s();
  ...
  function gt() {
    var e = /\/turnstile\/v0(\/.*)?\/api\.js/, t = document.currentScript;
  ...
  function pr() {
    ...
    var t = e.src, a = { loadedAsync: !1, params: new URLSearchParams(), src: t };
  ...
  var yt = function(e, t, a) {
      var o = pt(t.params, !1),
        ...
        l,
        m,
        h = "".concat(o, "/cdn-cgi/challenge-platform/").concat(c, "feedback-reports/").concat(Xe(e), "/").concat(
          t.displayLanguage,
          "/",
        ).concat((m = t.params.theme) !== null && m !== void 0 ? m : t.theme, "/").concat(a);
    ...
    vr = function(e) {
      var t, a, o;
      (o = document.getElementById(e)) === null || o === void 0 || (a = o.parentElement) === null || a === void 0
        || (t = a.parentElement) === null || t === void 0 || t.remove();
    };
  var Ye;
  (function(e) {
  ...
  function mr(e) {
    ...
    var t = function(a, o) {
      ...
      var m = ht(a.tagName.toLowerCase()), h = "".concat(m, "[").concat(c, "]");
  ...
  function hr(e, t, a) {
    for (
      var o = "",
        c = 0,
        l = document.createNodeIterator(e, NodeFilter.SHOW_ELEMENT | NodeFilter.SHOW_TEXT, {
  ...
  function br(e, t) {
    ...
    if (!(!o || !o.parentNode)) {
      ...
      e._pState = t;
      var l = new URL(o.src), m = document.createElement("script");
      l.searchParams.set("_upgrade", "true"),
        ...
        m.src = l.toString(),
        o == null || (a = o.parentNode) === null || a === void 0 || a.replaceChild(m, o);
    }
  }
  function xr(e, t) {
    var a = e._pState;
      ...
      for (var c = e.widgetMap[Symbol.iterator](), l; !(t = (l = c.next()).done); t = !0) {
        ...
        if (!_ || !s.shadow) {
          s.watchcat.missingWidgetWarning
            || (x("Cannot find Widget ".concat(_, ", consider using turnstile.remove() to clean up a widget.")),
        ...
        if (!(s.isComplete || s.isFailed || s.isResetting)) {
          ...
          if (
            (s.isExecuting || !s.isInitialized || s.isInitialized && !s.isStale && !s.isExecuted)
              && s.watchcat.lastAckedSeq !== 0 && k || N
          ) {
            var R;
          ...
          (p = A.contentWindow) === null || p === void 0
            || p.postMessage({ event: "meow", seq: e.watchCatSeq, source: W, widgetId: h }, "*");
        }
      }
    } catch (r) {
      a = !0, o = r;
    ...
    if (!(t === void 0 || t.hasResponseParamEl)) {
      ...
      if (o) {
        ...
        if (
          ...
          && Ir((m = t.params.sitekey) !== null && m !== void 0 ? m : "")
        ) {
  ...
  function Lt(e, t) {
    var a = t.params, o = a.size, c = o === void 0 ? "normal" : o, l = t.mode;
    switch (l) {
      ...
      case z.Managed:
        switch (c) {
          ...
          case M.Invisible:
            v(
              "Invalid value for parameter \"size\", expected \"".concat(M.Compact, "\", \"").concat(
                M.Flexible,
                "\", or \"",
              ).concat(M.Normal, "\", got \"").concat(c, "\""),
              2817,
            );
          case M.Normal:
      ...
      default:
        v(
          "Invalid value for parameter \"mode\", expected \"".concat(z.NonInteractive, "\", \"").concat(
            z.Managed,
            "\" or \"",
          ).concat(z.Invisible, "\", got \"").concat(l, "\""),
          2818,
        );
    }
  }
  ...
  function Gr(e) {
    return e.origin
      ? e.origin === "https://challenges.cloudflare.com" || e.origin === "https://challenges-staging.cloudflare.com"
      : !0;
  }
  function Ir(e) {
  ...
  var Vt = function() {
    var e = function(n, i, r, u) {
      ...
      a = function(n, i, r) {
        var u;
        n.response === void 0 && v("[Internal Error] Widget was completed but no response was given", 1362),
          n.isExecuting = !1,
          n.isComplete = !0,
          Ar(i, n.response),
      ...
      m = function(n) {
        ...
        try {
          for (var d = y.widgetMap[Symbol.iterator](), g; !(i = (g = d.next()).done); i = !0) {
            var w = Oe(g.value, 2), E = w[0], S = w[1];
      ...
      h = function(n, i, r) {
        for (; n.msgQueue.length > 0;) {
          ...
          (u = r.contentWindow) === null || u === void 0 || u.postMessage({ event: d, source: W, widgetId: i }, "*");
        }
      },
      s = function(n, i) {
        if (i) {
          ...
          && v(
            ...
            i.action
            && (Et(i.action)
              || v("Invalid input for optional parameter \"action\", got \"".concat(i.action, "\""), 3604),
              n.action = i.action),
            i.cData
            && (Tt(i.cData) || v("Invalid input for optional parameter \"cData\", got \"".concat(i.cData, "\""), 3605),
              n.cData = i.cData),
      ...
      _ = function(n, i) {
        ...
        if (u) {
          ...
          u.isResetting = !0,
            ...
            u.watchcat.seq = 0,
            u.params.execution === he.Render && (u.msgQueue.push(ce.Execute), u.isExecuted = !0, u.isExecuting = !0);
          var g = K(r), w = u.shadow.querySelector("#".concat(g));
          (!g || !w) && v("Widget ".concat(r, " to reset was not found."), 3330),
            u.params.appearance === Q.InteractionOnly && Rr(w),
            u.params.sitekey === null && v("Unexpected Error: Sitekey is null", 3347);
          var E = w.cloneNode(), S;
          E.src = vt(r, u.params.sitekey, u.params, (S = u.rcV) !== null && S !== void 0 ? S : Y, !1, "b", n, ut(u)),
      ...
      T = function(n, i) {
        ...
        if (typeof n == "string") {
          try {
            ...
            v(
              "Invalid type for \"container\", expected \"selector\" or an implementation of \"HTMLElement\", got \""
                .concat(n, "\""),
              3586,
            );
          }
        } else {P(n, HTMLElement)
            ? g = n
            : v(
              "Invalid type for parameter \"container\", expected \"string\" or an implementation of \"HTMLElement\"",
              3587,
            );}
        var E = !0, S = !1, I = void 0;
        try {
        ...
        var le = Xr(g);
        if (le) {
          var f = Object.assign(le, i), te = f.action, se = f.cData, xe = f.chlPageData, j = f.sitekey, de;
          ...
          && v(
            "Invalid or missing type for parameter \"sitekey\", expected \"string\", got \"".concat(
              typeof j == "undefined" ? "undefined" : F(j),
              "\"",
            ),
            3588,
          ),
            wr(j) || v("Invalid input for parameter \"sitekey\", got \"".concat(j, "\""), 3589),
            Rt(f.size)
            || v(
              "Invalid type for parameter \"size\", expected normal|compact, got \"".concat(f.size, "\" ").concat(
                F(f.size),
              ),
              3590,
            ),
            _t(f.theme)
            || v(
              "Invalid type for parameter \"theme\", expected dark|light|auto, got \"".concat(f.theme, "\" ").concat(
                F(f.theme),
              ),
              3591,
            ),
            bt(f.retry)
            || v(
              "Invalid type for parameter \"retry\", expected never|auto, got \"".concat(f.retry, "\" ").concat(
                F(f.retry),
              ),
              3592,
            ),
            ...
            Ot(f.execution)
            || v("Unknown execution value: \"".concat(f.execution, ", expected either: 'render' or 'execute'."), 3601),
            xt(f["retry-interval"])
            || v(
          ...
          St($)
            ? f["refresh-expired"] = $
            : v(
              "Invalid type for parameter \"refresh-expired\", expected never|manual|auto, got \"".concat($, "\" ")
                .concat(typeof $ == "undefined" ? "undefined" : F($)),
              3603,
            );
          var pe, Me = (pe = f["refresh-timeout"]) !== null && pe !== void 0 ? pe : oe.Auto;
          At($)
            ? f["refresh-timeout"] = Me
            : v(
              "Invalid type for parameter \"refresh-timeout\", expected never|manual|auto, got \"".concat(Me, "\" ")
                .concat(typeof Me == "undefined" ? "undefined" : F(Me)),
              3603,
            );
          var q = document.createElement("iframe"),
            ve = document.createElement("div"),
            Ut = ve.attachShadow({ mode: "closed" });
          ...
          var Ce = l(), me = K(Ce);
          if (!(!Ce || !me)) {
            var jt = [], et = f.execution === he.Render;
            ...
            y.widgetMap.set(
              ...
              ot(
                Ve({
                  ...
                  params: f,
                  rcV: Y,
                  watchcat: { lastAckedSeq: 0, missingWidgetWarning: !1, overrunBeginSeq: 0, seq: 0 },
                }, Cr),
                {
                  isOverrunning: !1,
                  shadow: Ut,
            ...
            tt || v("Turnstile Initialization Error ", 3606),
              ...
              q.setAttribute("src", vt(Ce, j, f, Y, !1, "b", H.New, ut(tt))),
              q.onerror = function() {
                if (ie) {
            ...
            L(
              (rt = (u = document.featurePolicy) === null || u === void 0 || (r = u.features) === null || r === void 0
                    ? void 0
                    : r.call(u)) !== null && rt !== void 0
                ? rt
                : [],
              ft,
            ) && qt.push(ft),
              q.setAttribute("allow", qt.join("; ")),
              q.setAttribute("sandbox", "allow-same-origin allow-scripts allow-popups"),
              q.id = me;
            var at;
            q.tabIndex = (at = f.tabindex) !== null && at !== void 0 ? at : 0,
              q.title = "Widget containing a Cloudflare security challenge",
              Ut.appendChild(q);
            ...
            if (Or) {
              ...
              var it;
              if (
                Le.name = (it = f["response-field-name"]) !== null && it !== void 0 ? it : st,
                  Le.id = "".concat(me, "_response"),
                  ve.appendChild(Le),
                  typeof f["response-field-name"] != "string" && Ir(j)
              ) {
      ...
      k = function() {
        ...
        try {
          for (var g = y.widgetMap[Symbol.iterator](), w; !(r = (w = g.next()).done); r = !0) {
            var E = Oe(w.value, 2), S = E[0], I = E[1];
            i < I.idx && (n = S, i = I.idx);
          }
        } catch (D) {
          u = !0, d = D;
          ...
          switch (V.label) {
            case 0:
              ...
              g = "h/".concat("b", "/"),
                ...
                E = "https",
                S = "",
                D = "".concat(E, "://").concat(w.host, "/cdn-cgi/challenge-platform/").concat(g, "rc/").concat(r)
                  .concat(S),
                V.label = 1;
            case 1:
              return V.trys.push([1, 3, , 4]), [
                4,
                fetch(D, {
                  body: JSON.stringify({ secondaryToken: i, sitekey: u }),
    ...
    var N = function(b) {
      ...
      if (n.source === W) {
        ...
        if (!(!n.widgetId || !y.widgetMap.has(n.widgetId))) {
          var i = K(n.widgetId), r = y.widgetMap.get(n.widgetId);
          if (!(!i || !r)) {
            switch (n.event) {
              case "init": {
                var u;
                ...
                d || v("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074),
                  r.mode = n.mode,
                  r.nextRcV = n.nextRcV,
                  r.mode === z.Invisible && r.params["refresh-expired"] === J.Manual
                  && x(
                    "refresh-expired=manual is impossible in invisible mode, consider using '".concat(J.Auto, "' or '")
                      .concat(J.Never, ".'"),
                  ),
                  r.mode !== z.Managed && r.params["refresh-timeout"] !== oe.Auto
                  && x(
                    "setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored.",
                  ),
                  r.params.appearance === Q.Always || r.isExecuting && r.params.appearance === Q.Execute
                    ? Lt(d, r)
                    : Rr(d),
                  d.style.display = "";
                var g = r.shadow.querySelector("#".concat(i));
                g || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                  (u = g.contentWindow) === null || u === void 0
                  || u.postMessage({ event: "init", source: W, widgetId: n.widgetId }, "*");
                break;
              }
              ...
              case "reject": {
                ...
                if (
                  r.isExecuting = !1,
                    S || v("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3075),
              ...
              case "fail": {
                n.rcV && c(r, n.rcV, n.widgetId),
                  ...
                  r.isInitialized = !0,
                  Mt(i);
                var D = r.cbError, B = n.code === Ue || n.code === je;
                if (B) {
                  var ee, V = r.shadow.querySelector("#".concat(i));
                  V == null || (ee = V.contentWindow) === null || ee === void 0
                    || ee.postMessage({ event: "forceFail", source: W, widgetId: n.widgetId }, "*");
                }
                if (D) {
                  var le;
                  D(String((le = n.code) !== null && le !== void 0 ? le : Zt))
                    ? r.params.retry === ye.Auto && !r.isResetting && t(r, i, B)
                    : (n.code && x("Error: ".concat(n.code, ".")), t(r, i, B));
              ...
              case "requestFeedbackData": {
                ...
                se || v("Received state for an unknown widget: #".concat(i, " / ").concat(n.widgetId), 3078),
                  (te = se.contentWindow) === null || te === void 0
                  || te.postMessage({ event: "requestTurnstileResults", source: W, widgetId: n.widgetId }, "*");
                break;
              }
              case "turnstileResults": {
                var xe,
                  j,
                  de = (xe = r.wrapper.parentNode) === null || xe === void 0
                    ? void 0
                    : xe.querySelector("#".concat(i, "-fr"));
                de || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                  (j = de.contentWindow) === null || j === void 0
                  || j.postMessage({
                    cfChlOut: r.cfChlOut,
              ...
              case "closeFeedbackReportIframe": {
                var re,
                  we = (re = r.wrapper.parentNode) === null || re === void 0
                    ? void 0
              ...
              case "interactiveTimeout": {
                ...
                if (
                  fe
                    ? fe()
                    : r.params["refresh-timeout"] === oe.Never && !r.isResetting
                      && x(
              ...
              case "interactiveBegin": {
                ...
                Ne || v("Cannot layout widget, Element not found (#".concat(i, ")."), 3076),
              ...
              case "requestExtraParams": {
                ...
                var ie = {},
                  ...
                  $ = U() - Ze;
                (Se = Ae.contentWindow) === null || Se === void 0 || Se.postMessage(
                  Ve({
                    action: r.action,
    ...
    return ot(Ve({}, X), {
      ...
      execute: function(n, i) {
        ...
        if (d) {
          ...
          var g = K(r);
          if (d.isExecuting) {
            x("Call to execute() on a widget that is already executing (".concat(
              g,
          ...
          if (d.isExecuting = !0, d.response) {
            var w;
            d.isExecuting = !1,
              x("Call to execute() on a widget that was already executed (".concat(
                g,
          ...
          d.isExpired && x("Call to execute on a expired-widget (".concat(g, "), consider using reset() before.")),
            d.isStale && (_(H.StaleExecute, g), d.isExecuting = !0),
            d.msgQueue.push(ce.Execute),
            d.isExecuted = !0;
          var E = d.shadow.querySelector("#".concat(g));
          if (E || (d.isExecuting = !1, v("Widget ".concat(g, " to execute was not found"), 43522)), d.isResetting) {
            return;
          }
          if (
            d.isInitialized && h(d, r, E),
              d.isInitialized && d.params.appearance === Q.Execute && Lt(E, d),
              d.isExecuting
          ) {
            var S, I = d.shadow.querySelector("#".concat(g));
            I || v("Received state for an unknown widget: ".concat(r), 3078),
              (S = I.contentWindow) === null || S === void 0
              || S.postMessage({ event: "execute", source: W, widgetId: r }, "*");
          }
        }
      },
      getResponse: function(n) {
        ...
        var g = R(n);
        return g || v("Could not find widget for provided container", 43778),
          (i = y.widgetMap.get(g)) === null || i === void 0 ? void 0 : i.response;
      },
      implicitRender: Pt,
      isExpired: function(n) {
        ...
        if (typeof n == "undefined") {
          ...
          if (r) {
            var u, d;
            return (d = (u = y.widgetMap.get(r)) === null || u === void 0 ? void 0 : u.isExpired) !== null
                && d !== void 0
              ? d
              : !1;
          }
        ...
        var w;
        return (w = (i = y.widgetMap.get(g)) === null || i === void 0 ? void 0 : i.isExpired) !== null && w !== void 0
          ? w
          : !1;
      },
      ready: function(n) {
          ...
          && (x("turnstile.ready() would break if called *before* the Turnstile api.js script is loaded by visitors."),
            ...
            && v(
              "turnstile.ready() expected a \"function\" argument, got \"".concat(
                typeof n == "undefined" ? "undefined" : F(n),
                "\"",
              ),
              3841,
            ),
  ...
  function Xr(e) {
    var t = e.getAttribute("data-sitekey"), a = { sitekey: t }, o = e.getAttribute("data-tabindex");
    ...
    if (_) {
      ...
      xt(A)
        ? a["retry-interval"] = A
        : x("Invalid data-retry-interval value: \"".concat(_, ", expected an integer value > 0 and < 900000\"."));
    }
    ...
    if (T) {
      ...
      wt(k)
        ? a["expiry-interval"] = k
        : x("Invalid data-expiry-interval value: \"".concat(k, ", expected an integer value > 0 and < 360000\"."));
    }
    var O = e.getAttribute("data-refresh-expired");
    O
      && (St(O)
        ? a["refresh-expired"] = O
        : x("Unknown data-refresh-expired value: \"".concat(O, ", expected either: 'never', 'auto' or 'manual'.")));
    var N = e.getAttribute("data-refresh-timeout");
    N
      && (At(N)
        ? a["refresh-timeout"] = N
        : x("Unknown data-refresh-timeout value: \"".concat(N, ", expected either: 'never', 'auto' or 'manual'.")));
    ...
    d
      && (Ot(d)
        ? a.execution = d
        : x("Unknown data-execution value: \"".concat(d, ", expected either: 'render' or 'execute'.")));
  ...
  _e = !1,
    C = pr(),
    y.scriptWasLoadedAsync = (Qe = C == null ? void 0 : C.loadedAsync) !== null && Qe !== void 0 ? Qe : !1,
    y.scriptUrl = (Ke = C == null ? void 0 : C.src) !== null && Ke !== void 0 ? Ke : "undefined",
    C != null && C.params && (be = C.params.get("compat"),
      (be == null ? void 0 : be.toLowerCase()) === "recaptcha"
        ? window.grecaptcha
          ? x("grecaptcha is already defined. The compatibility layer will not be enabled.")
          : (x("Compatibility layer enabled."), y.isRecaptchaCompatibilityMode = !0, window.grecaptcha = Vt)
        : be !== null && x("Unknown value for api.js?compat: \"".concat(be, "\", ignoring.")),
      C.params.forEach(function(e, t) {
        L(["onload", "compat", "_cb", "_upgrade", "_reload", "render"], t)
          || x("Unknown parameter passed to api.js: \"?".concat(t, "=...\", ignoring."));
      }),
      _e = C.params.get("_upgrade") === "true",
      G = C.params.get("onload"),
      G && !_e && setTimeout(function() {
        typeof window[G] == "function"
          ? window[G]()
          : (x(
            "Unable to find onload callback '".concat(G, "' immediately after loading, expected 'function', got '")
              .concat(F(window[G]), "'."),
          ),
            setTimeout(function() {
              typeof window[G] == "function"
                ? window[G]()
                : x(
                  "Unable to find onload callback '".concat(G, "' after 1 second, expected 'function', got '").concat(
                    F(window[G]),
                    "'.",
                  ),
                );
    ...
    Dt && !_e
      ...
      : (Dt && _e
        && (xr(window.turnstile, y),
          kt(y),
          (C == null || ($e = C.params) === null || $e === void 0 ? void 0 : $e.get("render")) !== "explicit"
          && setTimeout(Pt, 0)),
        window.turnstile = Vt,
        _e
        || ((C == null || (Je = C.params) === null || Je === void 0 ? void 0 : Je.get("render")) !== "explicit"
          && Wt.push(Pt),
          document.readyState === "complete" || document.readyState === "interactive"
            ? setTimeout(Tr, 0)
            : window.addEventListener("DOMContentLoaded", Tr))),
    Sr = 24 * 60 * 60 * 1e3,
    window.setTimeout(Yr, Sr);
